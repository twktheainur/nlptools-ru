...
# A simple regex-based utf-8 tokenizer for Python 2.7
...
class Tokenizer(object):
    ...
    def __init__(self):
        ...
        self.regexp = re.compile(ur'''
          ...
          (?:[{1}]) |                                                       # punctuation
          (?:.)                                                             # all the rest
        '''.format(ur"|".join([ur"(?:" + x + ur")(?!\w)" for x in self.abbrs.keys()]), string.punctuation + u"№«»…‰"), re.VERBOSE | re.UNICODE)
...
if __name__ == "__main__":
    ...
    text = u"Токенизация (tokenization, lexical analysis, графематический анализ, лексический анализ) - это когда в тексте выделяются слова, числа, и другие токены. Например, нахождение границ предложений. "  
